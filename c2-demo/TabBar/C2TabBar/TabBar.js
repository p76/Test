                ...
                navs[i] = (
                    <TouchableHighlight
                        ...
                        <View style={styles.center}>
                            ...
                            <Text allowFontScaling={false} style={[styles.navText, { color: color, fontSize: this.props.navFontSize }, this._stressPoint(child) ? styles.navTextChange : '']}>
                                {child.props.title}
                            </Text>
                            {this.getBadge(child) }
                        </View>
...
const styles = StyleSheet.create({
    ...
    navImage: {
        marginTop: 2,
        width: scaleN * (Platform.OS == 'ios' ? 10 : 6.5),
        height: scaleN * (Platform.OS == 'ios' ? 10 : 6.5),
    },
    navImageChange: {
        top: -28,
        width: 56,
    ...
    navText: {
        marginTop: scaleN * (Platform.OS == 'ios' ? 1.75 : 1),
        alignSelf: 'center',
    },
    horizonLine: {
