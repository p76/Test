...
export default class HomePage extends Component {
    ...
    _renderRow(rowData: any, sectionID: string, rowID: string) {
        return (
            <TouchableOpacity style={{ alignItems: 'center' }} onPress={() => Actions.ContentPage({ id: rowData.id })}>
    ...
    render() {
        ...
        return (
            <View style={css.standard}>
                <NavigationBar title="首页" faction='center' style={{ backgroundColor: 'rgb(30,144,255)' }}>
